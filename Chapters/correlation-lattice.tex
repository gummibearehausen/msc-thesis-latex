...
different categorical relations on a given numerical attribute's distribution. We call such graph a \graphname.  To
illustrate the idea, let's analyze a simple real-world example with the \emph{hasIncome} relation. If we have two
...
\subsection{Categorical Relation Definition}
...
\subsubsection{Absence or Presence of a Relation as Categories}
