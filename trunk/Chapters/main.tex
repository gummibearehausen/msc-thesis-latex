...
For example in figure \ref{interestingnessExample}, we have an ideal example where positive examples and body support
have completely different distributions and thus produce a very interesting confidence distribution.
...
In figure \ref{interestingnessDistribution}, we normalize the frequency histograms from the rule's positive examples
and body support in order to better show how their distributions diverge.
