\begin{tikzpicture}
 [scale=1.8,auto=left,every node/.style={circle,fill=black!20,font=\tiny}]
  ...
  \node (nb1c1)[fill=yellow!20] at (6.5,4.5)  {$r b_1 c_1$};
  \node (nb1c2)[fill=yellow!20] at (7.0,4.5)  {$r b_1 c_2$};
  \node (nb2c1)[fill=yellow!20] at (7.5,4.5)  {$r b_2 c_1$};
  \node (nb2c2)[fill=yellow!20] at (8.0,4.5)  {$r b_2 c_2$};
