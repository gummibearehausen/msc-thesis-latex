...
measure is very costy. As it concentrates on larger categories, the queries required for building the lattice are much
...
\begin{figure}
\caption{Number of interesting rules per runtime extracted }
\begin{tikzpicture}[scale=1.0]
 \begin{axis}[
	width=15cm, height=10cm,
        xlabel=\textsc{\#Nodes per lattice level},
